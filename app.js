...
let dbNameToUse = `jowaiteerresult`,
    dbURLToUse = `mongodb+srv://jowai:Jowai@2022@cluster0.xypov.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`

if((process.env.MODE) && (process.env.MODE.toLowerCase().trim() === `prod`)){
    dbNameToUse = `jowaiteerresultproduction`,
    dbURLToUse = `mongodb+srv://jowai:Jowai@2022@cluster0.xypov.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`
}
